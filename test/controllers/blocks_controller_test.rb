...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { content: @block.content, page_id: @block.page_id, position: @block.position } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { content: @block.content, page_id: @block.page_id, position: @block.position } }
