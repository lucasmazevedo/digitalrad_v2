...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { hero_image: @slider.hero_image, link: @slider.link, slug: @slider.slug, status: @slider.status, subtitle: @slider.subtitle, title: @slider.title } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { hero_image: @slider.hero_image, link: @slider.link, slug: @slider.slug, status: @slider.status, subtitle: @slider.subtitle, title: @slider.title } }
