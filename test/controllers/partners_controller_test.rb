...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { link: @partner.link, logo: @partner.logo, name: @partner.name, slug: @partner.slug, status: @partner.status } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { link: @partner.link, logo: @partner.logo, name: @partner.name, slug: @partner.slug, status: @partner.status } }
