...
class StructuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create structure" do
    assert_difference('Structure.count') do
      post structures_url, params: { structure: { photo: @structure.photo, status: @structure.status, subtitle: @structure.subtitle, title: @structure.title } }
    end
  ...
  test "should update structure" do
    patch structure_url(@structure), params: { structure: { photo: @structure.photo, status: @structure.status, subtitle: @structure.subtitle, title: @structure.title } }
