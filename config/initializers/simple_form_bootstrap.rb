...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'item bad', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-md-6 col-sm-6 col-xs-12' do |ba|
      ba.use :input, class: 'form-control col-md-7 col-xs-12', error_class: 'is-invalid', valid_class: 'is-valid'
      ba.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
    end
    b.use :full_error, wrap_with: { tag: 'div', class: 'alert' }
  end
