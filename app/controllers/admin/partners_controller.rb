class Admin::PartnersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @partner.save
        ...
        format.json { render :show, status: :created, location: [:admin, @partner] }
      else
  ...
  def update
    respond_to do |format|
      if @partner.update(partner_params)
        ...
        format.json { render :show, status: :ok, location: [:admin, @partner] }
      else
  ...
  private
    ...
    def partner_params
      params.require(:partner).permit(:name, :logo, :link, :slug, :status)
    end
end
