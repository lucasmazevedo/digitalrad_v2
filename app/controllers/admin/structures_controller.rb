class Admin::StructuresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @structure.save
        format.html { redirect_to admin_structures_path, notice: 'Structure was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @structure.update(structure_params)
        format.html { redirect_to admin_structures_path, notice: 'Structure was successfully updated.' }
  ...
  private
    ...
    def structure_params
      params.require(:structure).permit(:title, :subtitle, :photo, :status)
    end
end
